...
- [ZRX SDK for ZWCAD 2025](https://www.zwsoft.com/support/zwcad-devdoc/). Requires Visual Studio 2017.
...
3. Select either the `Release_ARX24`, `Release_BRX20` or `Release_ZRX25` solution configuration.
