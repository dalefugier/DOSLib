...
This repository contains the source code to DOSLib, a library of LISP-callable functions that provide functionality not available in CAD-based LISP engines, such as those included with AutoCAD, BricsCAD and ZWCAD.
...
When installing Visual Studio 2026, make sure to install the Visual Studio 2022 (v143), Visual Studio 2019 (v142) and Visual Studio 2017 (v141) C++ x64/x86 build tools and libraries, including ATL and MFC. 
